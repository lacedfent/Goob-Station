...
objective-condition-spy-description = Procure the {$itemName}. My employer will pay handsomely for it.
objective-condition-spy-animal-description = Procure the {$itemName} alive. My employer has a soft spot for the creature.
